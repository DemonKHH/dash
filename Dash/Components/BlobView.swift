...
//        path.addCurve(to: CGPoint(x: 0.6355*width*x2, y:height), control1: CGPoint(x: 0.92554*width*x2, y: 0.77749*height*x2), control2: CGPoint(x: 0.9186*width*x2, y: height))
...
////        let height = rect.size.width
////        path.move(to: CGPoint(x: 0.9923*width,y:0.42593*height))
////        path.addCurve(to: CGPoint(x: 0.6355*width, y:height), control1: CGPoint(x: 0.92554*width, y: 0.77749*height), control2: CGPoint(x: 0.9186*width, y: height))
